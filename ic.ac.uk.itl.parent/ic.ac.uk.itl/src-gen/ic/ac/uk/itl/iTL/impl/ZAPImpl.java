...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ZAP</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ic.ac.uk.itl.iTL.impl.ZAPImpl#getZap_target <em>Zap target</em>}</li>
 *   <li>{@link ic.ac.uk.itl.iTL.impl.ZAPImpl#getZap_address <em>Zap address</em>}</li>
 *   <li>{@link ic.ac.uk.itl.iTL.impl.ZAPImpl#getZap_max_depth <em>Zap max depth</em>}</li>
 *   <li>{@link ic.ac.uk.itl.iTL.impl.ZAPImpl#getZap_api_key <em>Zap api key</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZAPImpl extends testing_toolImpl implements ZAP
{
  /**
  ...
  {
    return ITLPackage.Literals.ZAP;
  }
  ...
  public NotificationChain basicSetZap_target(ZAP_TARGET newZap_target, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_TARGET, oldZap_target, newZap_target);
  ...
  public void setZap_target(ZAP_TARGET newZap_target)
  {
    if (newZap_target != zap_target)
    {
      ...
      if (zap_target != null)
        msgs = ((InternalEObject)zap_target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_TARGET, null, msgs);
      if (newZap_target != null)
        msgs = ((InternalEObject)newZap_target).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_TARGET, null, msgs);
      msgs = basicSetZap_target(newZap_target, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_TARGET, newZap_target, newZap_target));
  }
  ...
  public NotificationChain basicSetZap_address(ZAP_ADDRESS newZap_address, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_ADDRESS, oldZap_address, newZap_address);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setZap_address(ZAP_ADDRESS newZap_address)
  {
    if (newZap_address != zap_address)
    {
      NotificationChain msgs = null;
      if (zap_address != null)
        msgs = ((InternalEObject)zap_address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_ADDRESS, null, msgs);
      if (newZap_address != null)
        msgs = ((InternalEObject)newZap_address).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_ADDRESS, null, msgs);
      msgs = basicSetZap_address(newZap_address, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_ADDRESS, newZap_address, newZap_address));
  }
  ...
  public NotificationChain basicSetZap_max_depth(ZAP_MAX_DEPTH newZap_max_depth, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_MAX_DEPTH, oldZap_max_depth, newZap_max_depth);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setZap_max_depth(ZAP_MAX_DEPTH newZap_max_depth)
  {
    if (newZap_max_depth != zap_max_depth)
    {
      ...
      if (zap_max_depth != null)
        msgs = ((InternalEObject)zap_max_depth).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_MAX_DEPTH, null, msgs);
      if (newZap_max_depth != null)
        msgs = ((InternalEObject)newZap_max_depth).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_MAX_DEPTH, null, msgs);
      msgs = basicSetZap_max_depth(newZap_max_depth, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_MAX_DEPTH, newZap_max_depth, newZap_max_depth));
  }
  ...
  public NotificationChain basicSetZap_api_key(ZAP_API_KEY newZap_api_key, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_API_KEY, oldZap_api_key, newZap_api_key);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setZap_api_key(ZAP_API_KEY newZap_api_key)
  {
    if (newZap_api_key != zap_api_key)
    {
      NotificationChain msgs = null;
      if (zap_api_key != null)
        msgs = ((InternalEObject)zap_api_key).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_API_KEY, null, msgs);
      if (newZap_api_key != null)
        msgs = ((InternalEObject)newZap_api_key).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ITLPackage.ZAP__ZAP_API_KEY, null, msgs);
      msgs = basicSetZap_api_key(newZap_api_key, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ITLPackage.ZAP__ZAP_API_KEY, newZap_api_key, newZap_api_key));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ITLPackage.ZAP__ZAP_TARGET:
        return basicSetZap_target(null, msgs);
      case ITLPackage.ZAP__ZAP_ADDRESS:
        return basicSetZap_address(null, msgs);
      case ITLPackage.ZAP__ZAP_MAX_DEPTH:
        return basicSetZap_max_depth(null, msgs);
      case ITLPackage.ZAP__ZAP_API_KEY:
